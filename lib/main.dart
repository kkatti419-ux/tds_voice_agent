      ...
      child: Consumer<ThemeModeNotifier>(
        builder: (context, themeMode, _) {
          return MaterialApp(
            ...
            routes: {
              AppRoutes.solutions: (_) =>
                  const PlaceholderPage(title: 'Solutions'),
              AppRoutes.industries: (_) =>
                  const PlaceholderPage(title: 'Industries'),
              AppRoutes.platform: (_) =>
                  const PlaceholderPage(title: 'Platform'),
              AppRoutes.pricing: (_) =>
                  const PlaceholderPage(title: 'Pricing'),
              ...
              AppRoutes.nityaAi: (_) =>
                  const PlaceholderPage(title: 'Nitya.AI'),
              AppRoutes.careers: (_) =>
                  const PlaceholderPage(title: 'Careers'),
              AppRoutes.linkedin: (_) =>
                  const PlaceholderPage(title: 'LinkedIn'),
              AppRoutes.twitter: (_) =>
                  const PlaceholderPage(title: 'Twitter'),
